...
function sharedFooter() {
  return `<footer><a class="brand" href="../index.html"><span class="brand-mark"><img src="../assets/images/maskan-logo.png" alt=""></span><span><b>مسكن الكيان</b><small>للمقاولات</small></span></a><p>© 2026 مسكن الكيان للمقاولات. جميع الحقوق محفوظة.</p><a href="#top">العودة للأعلى ↑</a></footer>`;
}
...
function applySavedSiteConfig() {
  try {
    ...
    console.warn("تعذر تحميل إعدادات الموقع المحفوظة", error);
  }
}
